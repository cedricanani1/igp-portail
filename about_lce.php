...
<header id="header">
    ...
    <div class="container d-flex">
        ...
        <div id="lang" class="ml-auto ml-5 mt-2"  style="right:-32px">
            <span style="background-color:transparent; font-size: 17px;" class="badge badge-light">Fr <a href="./about_lce.php?lang=fr">
            ...
            <span style="background-color:transparent; font-size: 17px;" class="badge badge-light">
                 En<a href="./about_lce.php?lang=en"><img src="./assets/img/lang/en.png"
