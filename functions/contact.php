...
if (isset($_POST['name']) && isset($_POST['email']) && isset($_POST['subject']) && isset($_POST['message']) ) {
    ...
    //L'email qui reçoit
    $mailSend->addAddress($emailClient, $nameClient);
    $mailSend->isHTML(true);
    $mailSend->Subject = "Email response";
    $mailSend->addEmbeddedImage('../assets/img/images_mails/logo_lce.png', 'logo');
    $mailSend->addEmbeddedImage('../assets/img/images_mails/facebook2x.png', 'fb');
    $mailSend->addEmbeddedImage('../assets/img/images_mails/instagram2x.png', 'insta');
    $mailSend->addEmbeddedImage('../assets/img/images_mails/linkedin2x.png', 'linked');
    $mailSend->addEmbeddedImage('../assets/img/images_mails/twitter2x.png', 'twit');
    $mailSend->addEmbeddedImage('../assets/img/images_mails/Up_pink.png', 'up');
    $mailSend->addEmbeddedImage('../assets/img/images_mails/Welcome_Email.png', 'welcome');
    $mailSend->addEmbeddedImage('../assets/img/images_mails/white_down.png', 'white');
    $mailSend->addEmbeddedImage('../assets/img/images_mails/youtube2x.png', 'youtube');
    $mailSend->Body = "
        ...
        <!--[if mso]><table width=\"100%\" cellpadding=\"0\" cellspacing=\"0\" border=\"0\"><tr style=\"line-height:0px\"><td style=\"padding-right: 0px;padding-left: 0px;\" align=\"center\"><![endif]--><img align=\"center\" alt=\"I'm an image\" border=\"0\" class=\"center fixedwidth\"  src=\"cid:welcome\" style=\"text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 100%; max-width: 420px; display: block;\" title=\"I'm an image\" width=\"420\"/>
        <!--[if mso]></td></tr></table><![endif]-->
        </div>
        ...
        <p style=\"font-size: 22px; line-height: 1.2; text-align: center; word-break: break-word; mso-line-height-alt: 26px; margin: 0;\"><span style=\"font-size: 22px;\">
            Merci de nous avoir contacter, nous vous reviendrons dans un bref délai!</span></p>
        </div>
        </div>
        <!--[if mso]></td></tr></table><![endif]-->
        <table border=\"0\" cellpadding=\"0\" cellspacing=\"0\" class=\"divider\" role=\"presentation\" style=\"table-layout: fixed; vertical-align: top; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; min-width: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;\" valign=\"top\" width=\"100%\">
