        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item">
                ...
                <div class="carousel-caption d-none d-md-block" style="font-weight: bold;">
                    <h1>
                       IoT >>>>> <b class="kouame" data-elements="Le Futur c'est Maintenant !"></b> 
                    </h1>
                </div>
            </div>
          <!--  <div class="carousel-item">
...
<section class="home_pres" data-aos="fade-up">
    <div class="container">
        <div class="section-title">
            <h2 data-aos="fade-in" class="aos-init aos-animate">La locomotive</h2>
        </div>
        <div class="row">
