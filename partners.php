...
<header id="header">
    ...
    <div class="container d-flex">
        ...
        <div id="lang" class="ml-auto ml-5 mt-2"  style="right:-32px">
            <span style="background-color:transparent; font-size: 17px;" class="badge badge-light">Fr <a href="./partners.php?lang=fr">
            ...
            <span style="background-color:transparent; font-size: 17px;" class="badge badge-light">
                 En<a href="./partners.php?lang=en"><img src="./assets/img/lang/en.png"
