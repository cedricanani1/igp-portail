...
$lang = array(
    ...
    "home" => array(
        ...
        "c_7" => "Tertiary sector",
        "c_8" => "Business to Enterprise",
        "c_9" => "Public administration",
        "c_10" => " Embasies",
        "c_11" => " NGOs",
        "c_12" => "Mutuals",
        "c_13" => ""
    ...
    "about" => array(
        ...
        "contact" =>  array(
            "f1" => "CONTACTS",
            "f2" => "Submit your needs, our team will deal with your request within a short time.",
            "f3" => "Ivory Coast, Cocody new CHU Angré, Residence Bissié 1er Etage Appt D",
            "f4" => "Enter your name",
            "f5" => "Enter your email",
            "f6" => "Telephone",
            "f7" => "Object",
            "f8" => "Enter your message",
            "btn" => "Send",
